...
namespace NovinMedia.Data
{
	...
	public class DORSADbObject
	{
		...
		public DORSADbObject( string newConnectionString )
		{
			connectionString = newConnectionString;
			Connection = new SqlConnection( connectionString );
		}
        public DORSADbObject()
        {
            //connectionString = ConfigurationManager.ConnectionStrings["dataLayerBazarAzad1"].ToString();
            //connectionString = "Data Source=pfpsrv;Initial Catalog=ProcessControl;Persist Security Info=True;User ID=sa;Password=zfo4";
            connectionString = "Data Source=91.99.97.162;Initial Catalog=Dorsa9182890;Persist Security Info=True;User ID=Dorsa9182891;Password=DORSA_aWQAs8890LJhsss8@f";
            Connection = new SqlConnection(connectionString);
        }
